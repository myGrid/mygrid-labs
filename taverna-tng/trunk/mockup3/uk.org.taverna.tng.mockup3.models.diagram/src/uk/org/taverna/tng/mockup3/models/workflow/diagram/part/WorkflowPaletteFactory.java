...
public class WorkflowPaletteFactory {
	...
	private ToolEntry createComponentInstance1CreationTool() {
		...
		types.add(WorkflowElementTypes.ComponentInstance_2004);
		...
		entry
				.setSmallIcon(WorkflowElementTypes
						.getImageDescriptor(WorkflowElementTypes.ComponentInstance_2004));
	...
	private ToolEntry createWorkflowInput2CreationTool() {
		...
		types.add(WorkflowElementTypes.WorkflowInput_2003);
		NodeToolEntry entry = new NodeToolEntry(
	...
	private ToolEntry createWorkflowOutput3CreationTool() {
		...
		types.add(WorkflowElementTypes.WorkflowOutput_2002);
		NodeToolEntry entry = new NodeToolEntry(
		...
		entry.setSmallIcon(WorkflowElementTypes
				.getImageDescriptor(WorkflowElementTypes.WorkflowOutput_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
