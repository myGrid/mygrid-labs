...
import uk.org.taverna.tng.mockup3.models.workflow.diagram.edit.commands.SenderReceiversCreateCommand;
import uk.org.taverna.tng.mockup3.models.workflow.diagram.edit.commands.SenderReceiversReorientCommand;
 ...
 * @generated
 */
public class ComponentInstanceOutputItemSemanticEditPolicy extends
		WorkflowBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ComponentInstanceOutputItemSemanticEditPolicy() {
		super(WorkflowElementTypes.ComponentInstanceOutput_3002);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (WorkflowElementTypes.SenderReceivers_4002 == req.getElementType()) {
			return getGEFWrapper(new SenderReceiversCreateCommand(req, req
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SenderReceiversEditPart.VISUAL_ID:
			return getGEFWrapper(new SenderReceiversReorientCommand(req));
		}
