 ...
 * @generated
 */
public class WorkflowInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = WorkflowDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new WorkflowNewDiagramFileWizard(resource.getURI(),
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				WorkflowEditPart.MODEL_ID));
		WorkflowDiagramEditorUtil.runWizard(getShell(), wizard,
