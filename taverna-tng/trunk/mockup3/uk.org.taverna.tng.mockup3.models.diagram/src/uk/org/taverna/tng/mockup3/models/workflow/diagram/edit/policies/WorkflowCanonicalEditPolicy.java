...
import uk.org.taverna.tng.mockup3.models.workflow.diagram.part.WorkflowLinkDescriptor;
...
public class WorkflowCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = WorkflowDiagramUpdater
				.getWorkflow_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				WorkflowLinkDescriptor nextLinkDescriptor = (WorkflowLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final WorkflowLinkDescriptor nextLinkDescriptor = (WorkflowLinkDescriptor) linkDescriptorsIterator
					.next();
