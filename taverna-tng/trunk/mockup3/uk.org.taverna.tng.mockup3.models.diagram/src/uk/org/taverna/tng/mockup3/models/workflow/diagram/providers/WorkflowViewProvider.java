 ...
 * @generated
 */
public class WorkflowViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = WorkflowVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = WorkflowVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				...
				if (domainElement != null
						&& visualID != WorkflowVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!WorkflowEditPart.MODEL_ID.equals(WorkflowVisualIDRegistry
		...
		return ComponentInstanceEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case WorkflowOutputEditPart.VISUAL_ID:
			return createWorkflowInput_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case WorkflowInputEditPart.VISUAL_ID:
			return createWorkflowOutput_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case ComponentInstanceInputEditPart.VISUAL_ID:
			return createComponentInstanceInput_3001(domainElement,
					containerView, index, persisted, preferencesHint);
		case ComponentInstanceOutputEditPart.VISUAL_ID:
			return createComponentInstanceOutput_3002(domainElement,
					containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case SenderReceiversEditPart.VISUAL_ID:
			return createSenderReceivers_4002(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createComponentInstance_2001(EObject domainElement,
		...
		node.setType(WorkflowVisualIDRegistry
		...
		Node label5001 = createLabel(node, WorkflowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createWorkflowInput_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5002 = createLabel(node, WorkflowVisualIDRegistry
	...
	public Node createWorkflowOutput_2003(EObject domainElement,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5003 = createLabel(node, WorkflowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createComponentInstanceInput_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createComponentInstanceOutput_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createSenderReceivers_4002(View containerView, int index,
		...
		edge.setType(WorkflowVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!WorkflowEditPart.MODEL_ID.equals(WorkflowVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", WorkflowEditPart.MODEL_ID); //$NON-NLS-1$
