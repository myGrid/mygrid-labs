...
public class WorkflowElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType ComponentInstance_2001 = getElementType("uk.org.taverna.tng.mockup3.models.diagram.ComponentInstance_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkflowInput_2002 = getElementType("uk.org.taverna.tng.mockup3.models.diagram.WorkflowInput_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType WorkflowOutput_2003 = getElementType("uk.org.taverna.tng.mockup3.models.diagram.WorkflowOutput_2003"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ComponentInstance_2001, WorkflowPackage.eINSTANCE
					.getComponentInstance());

			elements.put(WorkflowInput_2002, WorkflowPackage.eINSTANCE
					.getWorkflowInput());

			elements.put(WorkflowOutput_2003, WorkflowPackage.eINSTANCE
					.getWorkflowOutput());
