...
import uk.org.taverna.tng.mockup3.models.workflow.diagram.application.WizardNewFileCreationPage;
...
public class WorkflowNewDiagramFileWizard extends Wizard {
	...
	public WorkflowNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage = new WizardNewFileCreationPage(
				Messages.WorkflowNewDiagramFileWizard_CreationPageName,
				StructuredSelection.EMPTY);
		myFileCreationPage
				.setTitle(Messages.WorkflowNewDiagramFileWizard_CreationPageTitle);
		myFileCreationPage.setDescription(NLS.bind(
				Messages.WorkflowNewDiagramFileWizard_CreationPageDescription,
		...
		myFileCreationPage.setFileName(WorkflowDiagramEditorUtil
				.getUniqueFileName(filePath, fileName, "workflow_diagram")); //$NON-NLS-1$

		diagramRootElementSelectionPage = new DiagramRootElementSelectionPage(
				Messages.WorkflowNewDiagramFileWizard_RootSelectionPageName);
		diagramRootElementSelectionPage
				.setTitle(Messages.WorkflowNewDiagramFileWizard_RootSelectionPageTitle);
		diagramRootElementSelectionPage
				.setDescription(Messages.WorkflowNewDiagramFileWizard_RootSelectionPageDescription);
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = WorkflowVisualIDRegistry
						.getDiagramVisualID(diagramRootElementSelectionPage
								.getModelElement());
				if (diagramVID != WorkflowEditPart.VISUAL_ID) {
					return CommandResult
							.newErrorCommandResult(Messages.WorkflowNewDiagramFileWizard_IncorrectRootError);
				}
