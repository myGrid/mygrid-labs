 ...
 * @generated
 */
public class WorkbenchViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = WorkbenchVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = WorkbenchVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!WorkbenchElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != WorkbenchVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!WorkflowEditPart.MODEL_ID.equals(WorkbenchVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = WorkbenchVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != WorkbenchVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = WorkbenchVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = WorkbenchVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ComponentEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (WorkbenchVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createComponent_2001(EObject domainElement, View containerView,
		...
		node.setType(WorkbenchVisualIDRegistry
		...
		Node label5001 = createLabel(node, WorkbenchVisualIDRegistry
