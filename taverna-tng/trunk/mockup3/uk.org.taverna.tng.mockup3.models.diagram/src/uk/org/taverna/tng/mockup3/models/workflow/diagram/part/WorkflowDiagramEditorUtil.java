...
public class WorkflowDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.WorkflowDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.WorkflowDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = WorkflowDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						Messages.WorkflowDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(uk.org.taverna.tng.mockup3.models.workflow.diagram.part.WorkflowDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(uk.org.taverna.tng.mockup3.models.workflow.diagram.part.WorkflowDiagramEditorUtil
									.getSaveOptions());
