 ...
 * @generated
 */
public class WorkbenchInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new WorkbenchNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				WorkflowEditPart.MODEL_ID));
		WorkbenchDiagramEditorUtil.runWizard(getShell(), wizard,
