...
public class WorkflowItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (WorkflowElementTypes.ComponentInstance_2004 == req.getElementType()) {
			return getGEFWrapper(new ComponentInstanceCreateCommand(req));
		}
		if (WorkflowElementTypes.WorkflowInput_2003 == req.getElementType()) {
			return getGEFWrapper(new WorkflowInputCreateCommand(req));
		}
		if (WorkflowElementTypes.WorkflowOutput_2002 == req.getElementType()) {
