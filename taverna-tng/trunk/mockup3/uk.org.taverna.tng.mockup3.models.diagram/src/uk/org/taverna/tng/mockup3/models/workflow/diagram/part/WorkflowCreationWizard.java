...
public class WorkflowCreationWizard extends Wizard implements INewWizard {
	 ...
	 * @generated
	 */
	protected WorkflowCreationWizardPage domainModelFilePage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(Messages.WorkflowCreationWizardTitle);
		setDefaultPageImageDescriptor(WorkflowDiagramEditorPlugin
	...
	public void addPages() {
		...
		diagramModelFilePage
				.setTitle(Messages.WorkflowCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage
			...
			public void setVisible(boolean visible) {
				if (visible) {
					...
					fileName = fileName.substring(0, fileName.length()
							- ".workflow_diagram".length()); //$NON-NLS-1$
					setFileName(WorkflowDiagramEditorUtil.getUniqueFileName(
							getContainerFullPath(), fileName, "workflow")); //$NON-NLS-1$
				}
	...
	public boolean performFinish() {
				...
				if (isOpenNewlyCreatedDiagramEditor() && diagram != null) {
					try {
						...
						ErrorDialog.openError(getContainer().getShell(),
								Messages.WorkflowCreationWizardOpenEditorError,
								null, e.getStatus());
					}
				}
			}
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog.openError(getContainer().getShell(),
						Messages.WorkflowCreationWizardCreationError, null,
