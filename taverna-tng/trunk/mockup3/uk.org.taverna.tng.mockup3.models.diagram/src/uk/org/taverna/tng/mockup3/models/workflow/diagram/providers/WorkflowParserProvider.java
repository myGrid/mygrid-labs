...
import uk.org.taverna.tng.mockup3.models.workflow.diagram.parsers.MessageFormatParser;
...
public class WorkflowParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser componentInstanceName_5004Parser;

	/**
	 * @generated
	 */
	private IParser getComponentInstanceName_5004Parser() {
		if (componentInstanceName_5004Parser == null) {
			EAttribute[] features = new EAttribute[] { WorkflowPackage.eINSTANCE
					.getComponentInstance_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			componentInstanceName_5004Parser = parser;
		}
		return componentInstanceName_5004Parser;
	}

	/**
	 * @generated
	 */
	private IParser workflowInputName_5003Parser;

	/**
	 * @generated
	 */
	private IParser getWorkflowInputName_5003Parser() {
		if (workflowInputName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { WorkflowPackage.eINSTANCE
					.getPort_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			workflowInputName_5003Parser = parser;
		}
		return workflowInputName_5003Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case ComponentInstanceNameEditPart.VISUAL_ID:
			return getComponentInstanceName_5004Parser();
		case WorkflowInputNameEditPart.VISUAL_ID:
			return getWorkflowInputName_5003Parser();
