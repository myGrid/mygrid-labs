	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkflowPackage.WORKFLOW_INPUT: {
				...
				if (result == null) result = caseReceiver(workflowInput);
			...
			case WorkflowPackage.WORKFLOW_OUTPUT: {
				...
				if (result == null) result = caseSender(workflowOutput);
				if (result == null) result = casePort(workflowOutput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.COMPONENT_INSTANCE_INPUT: {
			...
			case WorkflowPackage.COMPONENT_INSTANCE_OUTPUT: {
				...
				if (result == null) result = caseReceiver(componentInstanceOutput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
