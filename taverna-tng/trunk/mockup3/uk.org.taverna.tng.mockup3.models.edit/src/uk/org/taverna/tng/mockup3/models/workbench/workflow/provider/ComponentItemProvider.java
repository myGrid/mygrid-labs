...
/**
 * This is the item provider adapter for a {@link uk.org.taverna.tng.mockup3.models.workbench.workflow.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFamilyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_family_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_family_feature", "_UI_Component_type"),
				 WorkflowPackage.Literals.COMPONENT__FAMILY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addActivityTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_activityType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_activityType_feature", "_UI_Component_type"),
				 WorkflowPackage.Literals.COMPONENT__ACTIVITY_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.COMPONENT__INPUTS);
			childrenFeatures.add(WorkflowPackage.Literals.COMPONENT__OUTPUTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.COMPONENT__INPUTS,
				 WorkflowFactory.eINSTANCE.createComponentInput()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.COMPONENT__OUTPUTS,
				 WorkflowFactory.eINSTANCE.createComponentOutput()));
	}
