...
public class User extends Resource {
	...
	public void setName(String name) {
		this.name = name;
		this.setTitle(name); // this will allow to use name/title
								// interchangeably
	}
	...
	public static User buildFromXML(Element docRootElement, Logger logger) {
		...
		try {
			...
			user.setDescription(docRootElement.getChild("description")
					.getText());
			...
			if (avatarElement != null) {
				user.setAvatarResource(avatarElement
			...
			if (workflowsElement != null) {
				Iterator<Element> iWorkflows = workflowsElement.getChildren()
						.iterator();
				Util.getResourceCollectionFromXMLIterator(iWorkflows,
						user.workflows);
			}
			...
			if (filesElement != null) {
				Iterator<Element> iFiles = filesElement.getChildren()
						.iterator();
			...
			if (packsElement != null) {
				Iterator<Element> iPacks = packsElement.getChildren()
						.iterator();
			...
			if (filesElement != null) {
				Iterator<Element> iFriends = friendsElement.getChildren()
						.iterator();
				Util.getResourceCollectionFromXMLIterator(iFriends,
						user.friends);
			}
			...
			if (groupsElement != null) {
				Iterator<Element> iGroups = groupsElement.getChildren()
						.iterator();
