...
public class Util {
	...
	public static List<Resource> retrieveUserFavourites(Element docRootElement) {
		...
		if (favouritesElement != null) {
			...
			while (iFavourites.hasNext()) {
				favouritedItemList.add(Util
						.instantiatePrimitiveResourceFromElement(iFavourites
								.next()));
			}
		}
	...
	public static List<Resource> retrieveAttributions(Element docRootElement) {
		...
		if (attributionsElement != null) {
			...
			for (Element e : attributionsNodes) {
				attributions.add(Util
						.instantiatePrimitiveResourceFromElement(e));
			}
		}
	 ...
	 * 
	 * @param queryInstance
	 *            Instance of {@link QuerySearchInstance} that contains details
	 *            on the current search by query or null value if search by tag
	 *            is being made.
	 */
	public static String composeAPIQueryElements(
			QuerySearchInstance queryInstance) {
		...
		TreeSet<String> elementSet = new TreeSet<String>(
				Arrays.asList(strElements.split(",")));
