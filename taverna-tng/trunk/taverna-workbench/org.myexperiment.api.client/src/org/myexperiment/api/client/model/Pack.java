...
public class Pack extends Resource {
	...
	public static Pack buildFromXML(Element docRootElement,
		...
		try {
			// Access type
			p.setAccessType(Util.getAccessTypeFromXMLElement(docRootElement
					.getChild("privileges")));
			...
			Element itemsElement = docRootElement
			...
			if (itemsElement != null) {
				...
				for (Element e : itemsNodes) {
					Document docCurrentItem = client.getResource(
							Resource.PACK_INTERNAL_ITEM,
							e.getAttributeValue("uri"),
