 ...
 * @generated
 */
public class ComponentInputCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ComponentInputCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ComponentInput newElement = CanvasFactory.eINSTANCE
				.createComponentInput();

		Component owner = (Component) getElementToEdit();
		owner.getComponentInputs().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ComponentInput newElement,
