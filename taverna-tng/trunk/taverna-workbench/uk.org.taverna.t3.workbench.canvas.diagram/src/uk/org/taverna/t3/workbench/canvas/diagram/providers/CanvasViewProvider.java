...
public class CanvasViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ComponentEditPart.VISUAL_ID == visualID
				...
				|| WorkflowInputEditPart.VISUAL_ID == visualID
				|| Processor2EditPart.VISUAL_ID == visualID
				|| ProcessorInputEditPart.VISUAL_ID == visualID
				|| ProcessorOutputEditPart.VISUAL_ID == visualID
				|| ComponentInputEditPart.VISUAL_ID == visualID
				|| ComponentOutputEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ComponentEditPart.VISUAL_ID:
			return createComponent_2004(domainElement, containerView, index,
		...
		case WorkflowInputEditPart.VISUAL_ID:
			return createWorkflowInput_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case Processor2EditPart.VISUAL_ID:
			return createProcessor_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProcessorInputEditPart.VISUAL_ID:
			return createProcessorInput_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case ProcessorOutputEditPart.VISUAL_ID:
			return createProcessorOutput_3003(domainElement, containerView,
					index, persisted, preferencesHint);
		case ComponentInputEditPart.VISUAL_ID:
			return createComponentInput_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case ComponentOutputEditPart.VISUAL_ID:
			return createComponentOutput_3005(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case SenderReceiversEditPart.VISUAL_ID:
			return createSenderReceivers_4003(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createComponent_2004(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createProcessor_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CanvasVisualIDRegistry
				.getType(Processor2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5003 = createLabel(node,
				CanvasVisualIDRegistry.getType(ProcessorNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createProcessorInput_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CanvasVisualIDRegistry
				.getType(ProcessorInputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createProcessorOutput_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CanvasVisualIDRegistry
				.getType(ProcessorOutputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createComponentInput_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CanvasVisualIDRegistry
				.getType(ComponentInputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createComponentOutput_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CanvasVisualIDRegistry
				.getType(ComponentOutputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createSenderReceivers_4003(View containerView, int index,
