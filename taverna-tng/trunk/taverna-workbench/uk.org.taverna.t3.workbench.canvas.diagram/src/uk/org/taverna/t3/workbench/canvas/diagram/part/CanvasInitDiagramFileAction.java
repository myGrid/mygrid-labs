 ...
 * @generated
 */
public class CanvasInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new CanvasNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				CanvasEditPart.MODEL_ID));
		CanvasDiagramEditorUtil
