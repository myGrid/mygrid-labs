...
import uk.org.taverna.t3.workbench.canvas.diagram.part.CanvasDiagramUpdater;
import uk.org.taverna.t3.workbench.canvas.diagram.part.CanvasLinkDescriptor;
import uk.org.taverna.t3.workbench.canvas.diagram.part.CanvasNodeDescriptor;
...
public class CanvasCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(CanvasPackage.eINSTANCE
					.getCanvas_Inputs());
			myFeaturesToSynchronize.add(CanvasPackage.eINSTANCE
					.getCanvas_Nodes());
			myFeaturesToSynchronize.add(CanvasPackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<CanvasNodeDescriptor> childDescriptors = CanvasDiagramUpdater
				.getCanvas_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = CanvasVisualIDRegistry.getVisualID(view);
		return visualID == WorkflowInputEditPart.VISUAL_ID
				|| visualID == NodeEditPart.VISUAL_ID
				|| visualID == WorkflowOutputEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<CanvasNodeDescriptor> childDescriptors = CanvasDiagramUpdater
				.getCanvas_1000SemanticChildren((View) getHost().getModel());
		...
		for (Iterator<CanvasNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			CanvasNodeDescriptor next = descriptorsIterator.next();
			String hint = CanvasVisualIDRegistry.getType(next.getVisualID());
		...
		for (CanvasNodeDescriptor next : childDescriptors) {
			String hint = CanvasVisualIDRegistry.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<CanvasLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = CanvasVisualIDRegistry
			...
			for (Iterator<CanvasLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				CanvasLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<CanvasLinkDescriptor> collectAllLinks(View view,
		...
		case CanvasEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getCanvas_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case WorkflowInputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getWorkflowInput_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case WorkflowOutputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getWorkflowOutput_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CoreComponentInstanceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getCoreComponentInstance_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ComponentInstanceInputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getComponentInstanceInput_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ComponentInstanceOutputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getComponentInstanceOutput_3003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case HelperComponentInstanceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getHelperComponentInstance_3004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ComponentInstanceInput2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getComponentInstanceInput_3005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case ComponentInstanceOutput2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(CanvasDiagramUpdater
						.getComponentInstanceOutput_3006ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<CanvasLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (CanvasLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					CanvasVisualIDRegistry.getType(nextLinkDescriptor
