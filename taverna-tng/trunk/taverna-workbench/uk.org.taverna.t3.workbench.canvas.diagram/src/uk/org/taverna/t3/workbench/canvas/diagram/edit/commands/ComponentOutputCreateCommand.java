 ...
 * @generated
 */
public class ComponentOutputCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ComponentOutputCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ComponentOutput newElement = CanvasFactory.eINSTANCE
				.createComponentOutput();

		Component owner = (Component) getElementToEdit();
		owner.getComponentOutputs().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ComponentOutput newElement,
