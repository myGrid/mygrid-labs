...
import uk.org.taverna.t3.workbench.canvas.diagram.edit.policies.ComponentInputItemSemanticEditPolicy;
import uk.org.taverna.t3.workbench.canvas.diagram.providers.CanvasElementTypes;

/**
 * @generated
 */
public class ComponentInputEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ComponentInputEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentInputItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ComponentInputFigure();
	}

	/**
	 * @generated
	 */
	public ComponentInputFigure getPrimaryShape() {
		return (ComponentInputFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentInputEditPart) {
			types.add(CanvasElementTypes.SenderReceivers_4003);
		}
	 ...
	 * @generated
	 */
	public class ComponentInputFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel componentInputName0 = new WrappingLabel();
