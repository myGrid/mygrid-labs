...
import uk.org.taverna.t3.workbench.canvas.diagram.edit.commands.ComponentInstanceInput2CreateCommand;
import uk.org.taverna.t3.workbench.canvas.diagram.edit.commands.ComponentInstanceOutput2CreateCommand;
 ...
 * @generated
 */
public class HelperComponentInstanceItemSemanticEditPolicy extends
		CanvasBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public HelperComponentInstanceItemSemanticEditPolicy() {
		super(CanvasElementTypes.HelperComponentInstance_3004);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CanvasElementTypes.ComponentInstanceInput_3005 == req
				.getElementType()) {
			return getGEFWrapper(new ComponentInstanceInput2CreateCommand(req));
		}
		if (CanvasElementTypes.ComponentInstanceOutput_3006 == req
				.getElementType()) {
			return getGEFWrapper(new ComponentInstanceOutput2CreateCommand(req));
		}
