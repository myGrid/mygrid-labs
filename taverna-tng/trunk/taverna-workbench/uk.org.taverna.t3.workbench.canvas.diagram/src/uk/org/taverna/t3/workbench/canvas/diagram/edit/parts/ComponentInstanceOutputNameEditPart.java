 ...
 * @generated
 */
public class ComponentInstanceOutputNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				CanvasVisualIDRegistry
						.getType(uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentInstanceOutputNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ComponentInstanceOutputNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider
					.getParser(
							CanvasElementTypes.ComponentInstanceOutput_3003,
							getParserElement(),
							CanvasVisualIDRegistry
									.getType(uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentInstanceOutputNameEditPart.VISUAL_ID));
		}
