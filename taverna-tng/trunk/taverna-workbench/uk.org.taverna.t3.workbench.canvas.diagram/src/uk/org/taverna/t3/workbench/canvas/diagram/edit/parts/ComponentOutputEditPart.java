...
import uk.org.taverna.t3.workbench.canvas.diagram.edit.policies.ComponentOutputItemSemanticEditPolicy;
import uk.org.taverna.t3.workbench.canvas.diagram.providers.CanvasElementTypes;

/**
 * @generated
 */
public class ComponentOutputEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ComponentOutputEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentOutputItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ComponentOutputFigure();
	}

	/**
	 * @generated
	 */
	public ComponentOutputFigure getPrimaryShape() {
		return (ComponentOutputFigure) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentOutputEditPart) {
			types.add(CanvasElementTypes.SenderReceivers_4003);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class ComponentOutputFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel componentOutputName0 = new WrappingLabel();
