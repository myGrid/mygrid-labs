...
import uk.org.taverna.t3.workbench.canvas.models.workflow.provider.WorkflowItemProviderAdapterFactory;
...
public class WorkflowDiagramEditorPlugin extends AbstractUIPlugin {
	...
	public void setLinkConstraints(
			WorkflowBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, WorkflowDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, WorkflowDiagramEditorPlugin.ID,
