...
import uk.org.taverna.t3.workbench.canvas.diagram.edit.commands.SenderReceiversCreateCommand;
import uk.org.taverna.t3.workbench.canvas.diagram.edit.commands.SenderReceiversReorientCommand;
...
public class ComponentInstanceOutputItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (WorkflowElementTypes.SenderReceivers_4002 == req.getElementType()) {
			return getGEFWrapper(new SenderReceiversCreateCommand(req,
