 ...
 * @generated
 */
public class ComponentInstanceOutputName2EditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				CanvasVisualIDRegistry
						.getType(uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentInstanceOutputName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ComponentInstanceOutputName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider
					.getParser(
							CanvasElementTypes.ComponentInstanceOutput_3006,
							getParserElement(),
							CanvasVisualIDRegistry
									.getType(uk.org.taverna.t3.workbench.canvas.diagram.edit.parts.ComponentInstanceOutputName2EditPart.VISUAL_ID));
		}
	...
	protected IFigure createFigurePrim() {
		return new ComponentInstanceOutputFigure();
	}
