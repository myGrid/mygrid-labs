 ...
 * @generated
 */
public class CoreComponentInstanceItemSemanticEditPolicy extends
		CanvasBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CoreComponentInstanceItemSemanticEditPolicy() {
		super(CanvasElementTypes.CoreComponentInstance_3001);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CanvasElementTypes.ComponentInstanceInput_3002 == req
				.getElementType()) {
			return getGEFWrapper(new ComponentInstanceInputCreateCommand(req));
		}
		if (CanvasElementTypes.ComponentInstanceOutput_3003 == req
				.getElementType()) {
