...
public class PShelfStackPresentation extends StackPresentation
{
    ...
    public PShelfStackPresentation(IStackPresentationSite stackSite, Composite parent)
    {
        ...
        URL imageURL = Platform.getBundle("uk.org.taverna.t3.workbench.ui.presentations.shelf").getResource("icons/view_menu.gif");
        menuTBImage = ImageDescriptor.createFromURL(imageURL).createImage();

        imageURL = Platform.getBundle("uk.org.taverna.t3.workbench.ui.presentations.shelf").getResource("icons/close_view.gif");
        ...
        for (int i = 0; i < 8; i++)
        {            
            URL imgURL = Platform.getBundle("uk.org.taverna.t3.workbench.ui.presentations.shelf").getResource("icons/busy" + (i + 1) + ".gif");
