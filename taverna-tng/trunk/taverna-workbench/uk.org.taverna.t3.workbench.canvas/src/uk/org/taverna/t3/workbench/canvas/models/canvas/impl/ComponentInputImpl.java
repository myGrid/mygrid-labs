 ...
 * @generated
 */
public class ComponentInputImpl extends EObjectImpl implements ComponentInput {
	/**
	...
	protected EClass eStaticClass() {
		return CanvasPackage.Literals.COMPONENT_INPUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INPUT__NAME, oldName, name));
	}
	...
	public void setDepth(int newDepth) {
		...
		depth = newDepth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INPUT__DEPTH, oldDepth, depth));
	}
	...
	public EList<Receiver> getReceivers() {
		if (receivers == null) {
			receivers = new EObjectResolvingEList<Receiver>(Receiver.class, this, CanvasPackage.COMPONENT_INPUT__RECEIVERS);
		}
		return receivers;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Sender.class) {
			switch (derivedFeatureID) {
				case CanvasPackage.COMPONENT_INPUT__RECEIVERS: return CanvasPackage.SENDER__RECEIVERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Sender.class) {
			switch (baseFeatureID) {
				case CanvasPackage.SENDER__RECEIVERS: return CanvasPackage.COMPONENT_INPUT__RECEIVERS;
				default: return -1;
			}
		}
		if (baseClass == Receiver.class) {
