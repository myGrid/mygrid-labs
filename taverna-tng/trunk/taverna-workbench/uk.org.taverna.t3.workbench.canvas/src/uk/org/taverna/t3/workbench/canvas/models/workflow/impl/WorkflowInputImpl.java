 ...
 * <ul>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.workflow.impl.WorkflowInputImpl#getReceivers <em>Receivers</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.workflow.impl.WorkflowInputImpl#getSenders <em>Senders</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.workflow.impl.WorkflowInputImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.workflow.impl.WorkflowInputImpl#getDepth <em>Depth</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkflowInputImpl extends EObjectImpl implements WorkflowInput {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.WORKFLOW_INPUT;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.WORKFLOW_INPUT__NAME, oldName, name));
	}
	...
	public void setDepth(int newDepth) {
		...
		depth = newDepth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.WORKFLOW_INPUT__DEPTH, oldDepth, depth));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Port.class) {
			switch (derivedFeatureID) {
				case WorkflowPackage.WORKFLOW_INPUT__NAME: return WorkflowPackage.PORT__NAME;
				case WorkflowPackage.WORKFLOW_INPUT__DEPTH: return WorkflowPackage.PORT__DEPTH;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Port.class) {
			switch (baseFeatureID) {
				case WorkflowPackage.PORT__NAME: return WorkflowPackage.WORKFLOW_INPUT__NAME;
				case WorkflowPackage.PORT__DEPTH: return WorkflowPackage.WORKFLOW_INPUT__DEPTH;
				default: return -1;
			}
		}
