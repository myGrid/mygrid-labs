 ...
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ConfigurationPropertyImpl#getType <em>Type</em>}</li>
...
public class ConfigurationPropertyImpl extends EObjectImpl implements ConfigurationProperty {
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.CONFIGURATION_PROPERTY__TYPE, oldType, type));
	}
