 ...
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentOutputImpl#getLabel <em>Label</em>}</li>
...
public class ComponentOutputImpl extends EObjectImpl implements ComponentOutput {
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_OUTPUT__LABEL, oldLabel, label));
	}
