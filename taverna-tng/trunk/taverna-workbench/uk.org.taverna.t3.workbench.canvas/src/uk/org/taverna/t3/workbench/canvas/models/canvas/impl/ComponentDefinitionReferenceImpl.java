 ...
 * <ul>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentDefinitionReferenceImpl#getComponentDefinitionId <em>Component Definition Id</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentDefinitionReferenceImpl#getDiscoveryUrl <em>Discovery Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentDefinitionReferenceImpl extends EObjectImpl implements ComponentDefinitionReference {
	...
	protected EClass eStaticClass() {
		return CanvasPackage.Literals.COMPONENT_DEFINITION_REFERENCE;
	}
	...
	public void setComponentDefinitionId(String newComponentDefinitionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_DEFINITION_REFERENCE__COMPONENT_DEFINITION_ID, oldComponentDefinitionId, componentDefinitionId));
	}
	...
	public void setDiscoveryUrl(String newDiscoveryUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_DEFINITION_REFERENCE__DISCOVERY_URL, oldDiscoveryUrl, discoveryUrl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CanvasPackage.COMPONENT_DEFINITION_REFERENCE__COMPONENT_DEFINITION_ID:
				return getComponentDefinitionId();
			case CanvasPackage.COMPONENT_DEFINITION_REFERENCE__DISCOVERY_URL:
