 ...
 * <ul>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getActivityType <em>Activity Type</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link uk.org.taverna.t3.workbench.canvas.models.canvas.impl.ComponentInstanceImpl#getComponentDefinition <em>Component Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ComponentInstanceImpl extends EObjectImpl implements ComponentInstance {
	/**
	...
	protected EClass eStaticClass() {
		return CanvasPackage.Literals.COMPONENT_INSTANCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INSTANCE__NAME, oldName, name));
	}
	...
	public void setFamily(String newFamily) {
		...
		family = newFamily;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INSTANCE__FAMILY, oldFamily, family));
	}
	...
	public void setActivityType(String newActivityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INSTANCE__ACTIVITY_TYPE, oldActivityType, activityType));
	}
	...
	public EList<ComponentInstanceOutput> getOutputs() {
		if (outputs == null) {
			outputs = new EObjectContainmentEList<ComponentInstanceOutput>(ComponentInstanceOutput.class, this, CanvasPackage.COMPONENT_INSTANCE__OUTPUTS);
		}
		return outputs;
	}
	...
	public EList<ComponentInstanceInput> getInputs() {
		if (inputs == null) {
			inputs = new EObjectContainmentEList<ComponentInstanceInput>(ComponentInstanceInput.class, this, CanvasPackage.COMPONENT_INSTANCE__INPUTS);
		}
		return inputs;
	}
	...
	public ComponentDefinitionReference getComponentDefinition() {
		if (componentDefinition != null && componentDefinition.eIsProxy()) {
			...
			if (componentDefinition != oldComponentDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CanvasPackage.COMPONENT_INSTANCE__COMPONENT_DEFINITION, oldComponentDefinition, componentDefinition));
			}
		}
	...
	public void setComponentDefinition(ComponentDefinitionReference newComponentDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanvasPackage.COMPONENT_INSTANCE__COMPONENT_DEFINITION, oldComponentDefinition, componentDefinition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CanvasPackage.COMPONENT_INSTANCE__INPUTS:
				return getInputs();
			case CanvasPackage.COMPONENT_INSTANCE__COMPONENT_DEFINITION:
