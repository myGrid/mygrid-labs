...
//    url = Util.appendURLParameter(url, "q", "blast");
    BeansForJSONLiteAPI.SOAPOperationsIndex soapOpIndex = client.getBioCatalogueSoapOperationsLiteIndex(url);
    
    System.out.println("result count: " + soapOpIndex.soap_operations.length + "\n\n");
