 ...
 */
public class AgentImpl extends org.biocatalogue.x2009.xml.rest.impl.ResourceLinkImpl implements org.biocatalogue.x2009.xml.rest.Agent
{
     ...
     */
    public org.biocatalogue.x2009.xml.rest.AgentRelatedLinks getRelated()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.biocatalogue.x2009.xml.rest.AgentRelatedLinks target = null;
            target = (org.biocatalogue.x2009.xml.rest.AgentRelatedLinks)get_store().find_element_user(RELATED$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRelated(org.biocatalogue.x2009.xml.rest.AgentRelatedLinks related)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.biocatalogue.x2009.xml.rest.AgentRelatedLinks)get_store().add_element_user(RELATED$8);
            }
            target.set(related);
        }
    }
     ...
     */
    public org.biocatalogue.x2009.xml.rest.AgentRelatedLinks addNewRelated()
    {
        synchronized (monitor())
        {
            check_orphaned();
